...
namespace cpu {
  ...
  uint32_t read_data(cpu_state_t &state, bus_width_t width, uint32_t address);

  void write_data(cpu_state_t &state, bus_width_t width, uint32_t address, uint32_t data);

  void set_imask(cpu_state_t &state, uint32_t value);

  void set_istat(cpu_state_t &state, uint32_t value);

  uint32_t io_read(cpu_state_t &state, bus_width_t width, uint32_t address);

  void io_write(cpu_state_t &state, bus_width_t width, uint32_t address, uint32_t data);
