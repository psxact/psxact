...
bios::bios(opts &o) : bios_base(o, component::bios) {
  load_blob(o.get_bios_file());

  if (o.get_patch_enabled(bios_patch::skip_intro)) {
    io_write(address_width::word, 0x6990, 0x00000000); // nop
  }

  if (o.get_patch_enabled(bios_patch::debug_tty)) {
